...
## <a name="model-based-conventions"></a><span data-ttu-id="8ef1b-110">Vytváření názvů založených na modelu</span><span class="sxs-lookup"><span data-stu-id="8ef1b-110">Model-Based Conventions</span></span>
