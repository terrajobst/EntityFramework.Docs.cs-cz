...
| **&lt;**                                                                                | Ascend                      | Přejde na další objekt na návrhové plochy jeden úroveň výše v hierarchii. Pokud nejsou žádné prvky nad tohoto obrazce v hierarchii (tj. objekt je umístěn přímo na návrhové ploše), vybere se diagramu. |
