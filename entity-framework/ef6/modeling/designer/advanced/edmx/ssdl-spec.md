...
| <span data-ttu-id="da4e7-109">Verze souborů SSDL</span><span class="sxs-lookup"><span data-stu-id="da4e7-109">SSDL Version</span></span> | <span data-ttu-id="da4e7-110">Namespace XML</span><span class="sxs-lookup"><span data-stu-id="da4e7-110">XML Namespace</span></span>                                     |
|:-------------|:--------------------------------------------------|
...
| <span data-ttu-id="da4e7-126">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-126">Attribute Name</span></span> | <span data-ttu-id="da4e7-127">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-127">Is Required</span></span> | <span data-ttu-id="da4e7-128">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-128">Value</span></span>                                                                            |
|:---------------|:------------|:---------------------------------------------------------------------------------|
...
## <a name="commandtext-element-ssdl"></a><span data-ttu-id="da4e7-173">Element CommandText (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-173">CommandText Element (SSDL)</span></span>
...
## <a name="definingquery-element-ssdl"></a><span data-ttu-id="da4e7-182">Element DefiningQuery (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-182">DefiningQuery Element (SSDL)</span></span>
...
## <a name="dependent-element-ssdl"></a><span data-ttu-id="da4e7-194">Závislé – Element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-194">Dependent Element (SSDL)</span></span>
...
### <a name="example"></a><span data-ttu-id="da4e7-213">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-213">Example</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-223">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-223">Applicable Attributes</span></span>
...
### <a name="end-element-as-a-child-of-the-association-element"></a><span data-ttu-id="da4e7-233">Koncový Element jako podřízený Element přidružení</span><span class="sxs-lookup"><span data-stu-id="da4e7-233">End Element as a Child of the Association Element</span></span>
...
| <span data-ttu-id="da4e7-251">**Násobnost**</span><span class="sxs-lookup"><span data-stu-id="da4e7-251">**Multiplicity**</span></span> | <span data-ttu-id="da4e7-252">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-252">Yes</span></span>         | <span data-ttu-id="da4e7-253">**1**, **0..1**, nebo **\*** v závislosti na počtu řádků, které mohou být na konci omezení cizího klíče.</span><span class="sxs-lookup"><span data-stu-id="da4e7-253">**1**, **0..1**, or **\*** depending on the number of rows that can be at the end of the foreign key constraint.</span></span> <br/> <span data-ttu-id="da4e7-254">**1** označuje, že přesně jeden řádek existuje na konci omezení cizího klíče.</span><span class="sxs-lookup"><span data-stu-id="da4e7-254">**1** indicates that exactly one row exists at the foreign key constraint end.</span></span> <br/> <span data-ttu-id="da4e7-255">**0..1** znamená, že neexistuje žádný nebo jeden řádek na konci omezení cizího klíče.</span><span class="sxs-lookup"><span data-stu-id="da4e7-255">**0..1** indicates that zero or one row exists at the foreign key constraint end.</span></span> <br/> <span data-ttu-id="da4e7-256">**\*** Udává, že žádný, jeden nebo více řádků existuje na straně cizího klíče.</span><span class="sxs-lookup"><span data-stu-id="da4e7-256">**\*** indicates that zero, one, or more rows exist at the foreign key constraint end.</span></span> |
...
### <a name="end-element-as-a-child-of-the-associationset-element"></a><span data-ttu-id="da4e7-264">Koncový Element jako podřízený AssociationSet Element</span><span class="sxs-lookup"><span data-stu-id="da4e7-264">End Element as a Child of the AssociationSet Element</span></span>
...
### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-294">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-294">Applicable Attributes</span></span>
...
<span data-ttu-id="da4e7-347">**EntityType** prvek může mít následující podřízené prvky (v uvedeném pořadí):</span><span class="sxs-lookup"><span data-stu-id="da4e7-347">The **EntityType** element can have the following child elements (in the order listed):</span></span>
...
## <a name="function-element-ssdl"></a><span data-ttu-id="da4e7-366">Element Function (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-366">Function Element (SSDL)</span></span>
...
| <span data-ttu-id="da4e7-382">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-382">Attribute Name</span></span>             | <span data-ttu-id="da4e7-383">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-383">Is Required</span></span> | <span data-ttu-id="da4e7-384">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-384">Value</span></span>                                                                                                                                                                                                              |
|:---------------------------|:------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
## <a name="key-element-ssdl"></a><span data-ttu-id="da4e7-424">Klíčovým prvkem (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-424">Key Element (SSDL)</span></span>
...
-   <span data-ttu-id="da4e7-461">Elementů poznámky (nula nebo více)</span><span class="sxs-lookup"><span data-stu-id="da4e7-461">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-462">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-462">Applicable Attributes</span></span>

<span data-ttu-id="da4e7-463">Následující tabulka popisuje atributy, které mohou být použity **parametr** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-463">The table below describes the attributes that can be applied to the **Parameter** element.</span></span>

| <span data-ttu-id="da4e7-464">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-464">Attribute Name</span></span> | <span data-ttu-id="da4e7-465">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-465">Is Required</span></span> | <span data-ttu-id="da4e7-466">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-466">Value</span></span>                                                                                                                                                                                                                           |
|:---------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="da4e7-467">**Jméno**</span><span class="sxs-lookup"><span data-stu-id="da4e7-467">**Name**</span></span>       | <span data-ttu-id="da4e7-468">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-468">Yes</span></span>         | <span data-ttu-id="da4e7-469">Název parametru</span><span class="sxs-lookup"><span data-stu-id="da4e7-469">The name of the parameter.</span></span>                                                                                                                                                                                                      |
| <span data-ttu-id="da4e7-470">**Typ**</span><span class="sxs-lookup"><span data-stu-id="da4e7-470">**Type**</span></span>       | <span data-ttu-id="da4e7-471">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-471">Yes</span></span>         | <span data-ttu-id="da4e7-472">Typ parametru.</span><span class="sxs-lookup"><span data-stu-id="da4e7-472">The parameter type.</span></span>                                                                                                                                                                                                             |
| <span data-ttu-id="da4e7-473">**Režim**</span><span class="sxs-lookup"><span data-stu-id="da4e7-473">**Mode**</span></span>       | <span data-ttu-id="da4e7-474">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-474">No</span></span>          | <span data-ttu-id="da4e7-475">**V**, **si**, nebo **InOut** v závislosti na tom, zda je parametr vstup, výstup nebo vstupně výstupní parametr.</span><span class="sxs-lookup"><span data-stu-id="da4e7-475">**In**, **Out**, or **InOut** depending on whether the parameter is an input, output, or input/output parameter.</span></span>                                                                                                                |
| <span data-ttu-id="da4e7-476">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="da4e7-476">**MaxLength**</span></span>  | <span data-ttu-id="da4e7-477">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-477">No</span></span>          | <span data-ttu-id="da4e7-478">Maximální délka parametru.</span><span class="sxs-lookup"><span data-stu-id="da4e7-478">The maximum length of the parameter.</span></span>                                                                                                                                                                                            |
| <span data-ttu-id="da4e7-479">**Přesnost**</span><span class="sxs-lookup"><span data-stu-id="da4e7-479">**Precision**</span></span>  | <span data-ttu-id="da4e7-480">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-480">No</span></span>          | <span data-ttu-id="da4e7-481">Přesnost parametru.</span><span class="sxs-lookup"><span data-stu-id="da4e7-481">The precision of the parameter.</span></span>                                                                                                                                                                                                 |
| <span data-ttu-id="da4e7-482">**Škálování**</span><span class="sxs-lookup"><span data-stu-id="da4e7-482">**Scale**</span></span>      | <span data-ttu-id="da4e7-483">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-483">No</span></span>          | <span data-ttu-id="da4e7-484">Měřítko parametru.</span><span class="sxs-lookup"><span data-stu-id="da4e7-484">The scale of the parameter.</span></span>                                                                                                                                                                                                     |
| <span data-ttu-id="da4e7-485">**SRID**</span><span class="sxs-lookup"><span data-stu-id="da4e7-485">**SRID**</span></span>       | <span data-ttu-id="da4e7-486">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-486">No</span></span>          | <span data-ttu-id="da4e7-487">Odkaz na identifikátor spatial systému.</span><span class="sxs-lookup"><span data-stu-id="da4e7-487">Spatial System Reference Identifier.</span></span> <span data-ttu-id="da4e7-488">Platí jenom pro parametry prostorových typů.</span><span class="sxs-lookup"><span data-stu-id="da4e7-488">Valid only for parameters of spatial types.</span></span> <span data-ttu-id="da4e7-489">Další informace najdete v tématu [SRID](http://en.wikipedia.org/wiki/SRID) a [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="da4e7-489">For more information, see [SRID](http://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |

> [!NOTE]
> <span data-ttu-id="da4e7-490">Libovolný počet atributů poznámky (vlastní atributy XML) lze na **parametr** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-490">Any number of annotation attributes (custom XML attributes) may be applied to the **Parameter** element.</span></span> <span data-ttu-id="da4e7-491">Uživatelských atributů, které však nemusí patřit do libovolný obor názvů XML, který je vyhrazen pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-491">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="da4e7-492">Plně kvalifikovaných názvů pro všemi dvě vlastními atributy nemůže být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-492">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-493">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-493">Example</span></span>

<span data-ttu-id="da4e7-494">Následující příklad ukazuje **funkce** element, který má dva **parametr** elementy, které určují vstupní parametry:</span><span class="sxs-lookup"><span data-stu-id="da4e7-494">The following example shows a **Function** element that has two **Parameter** elements that specify input parameters:</span></span>
...
## <a name="principal-element-ssdl"></a><span data-ttu-id="da4e7-495">Instanční objekt – Element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-495">Principal Element (SSDL)</span></span>

<span data-ttu-id="da4e7-496">**Hlavní** prvek store schema definition language (SSDL) je podřízeným prvkem prvku elementu ReferentialConstraint, který definuje hlavní konec omezení cizího klíče (tzv. referenční omezení).</span><span class="sxs-lookup"><span data-stu-id="da4e7-496">The **Principal** element in store schema definition language (SSDL) is a child element to the ReferentialConstraint element that defines the principal end of a foreign key constraint (also called a referential constraint).</span></span> <span data-ttu-id="da4e7-497">**Hlavní** prvek určuje sloupec primárního klíče (nebo sloupce) v tabulce, na který odkazuje jiný sloupec (nebo sloupce).</span><span class="sxs-lookup"><span data-stu-id="da4e7-497">The **Principal** element specifies the primary key column (or columns) in a table that is referenced by another column (or columns).</span></span> <span data-ttu-id="da4e7-498">**PropertyRef** určují prvky sloupce, které jsou odkazovány.</span><span class="sxs-lookup"><span data-stu-id="da4e7-498">**PropertyRef** elements specify which columns are referenced.</span></span> <span data-ttu-id="da4e7-499">Určuje sloupce, které odkazují na sloupce primárního klíče, které jsou určené v elementu závislé **instančního objektu** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-499">The Dependent element specifies columns that reference the primary key columns that are specified in the **Principal** element.</span></span>

<span data-ttu-id="da4e7-500">**Hlavní** prvek může mít následující podřízené prvky (v uvedeném pořadí):</span><span class="sxs-lookup"><span data-stu-id="da4e7-500">The **Principal** element can have the following child elements (in the order listed):</span></span>

-   <span data-ttu-id="da4e7-501">PropertyRef (jeden nebo více)</span><span class="sxs-lookup"><span data-stu-id="da4e7-501">PropertyRef (one or more)</span></span>
-   <span data-ttu-id="da4e7-502">Elementů poznámky (nula nebo více)</span><span class="sxs-lookup"><span data-stu-id="da4e7-502">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-503">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-503">Applicable Attributes</span></span>

<span data-ttu-id="da4e7-504">Následující tabulka popisuje atributy, které mohou být použity **hlavní** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-504">The following table describes the attributes that can be applied to the **Principal** element.</span></span>

| <span data-ttu-id="da4e7-505">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-505">Attribute Name</span></span> | <span data-ttu-id="da4e7-506">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-506">Is Required</span></span> | <span data-ttu-id="da4e7-507">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-507">Value</span></span>                                                                                                                                                      |
|:---------------|:------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="da4e7-508">**Role**</span><span class="sxs-lookup"><span data-stu-id="da4e7-508">**Role**</span></span>       | <span data-ttu-id="da4e7-509">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-509">Yes</span></span>         | <span data-ttu-id="da4e7-510">Stejná hodnota jako **Role** atribut (Pokud se používá) odpovídajícího prvku End; v opačném případě se název tabulky, který obsahuje Odkazovaný sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-510">The same value as the **Role** attribute (if used) of the corresponding End element; otherwise, the name of the table that contains the referenced column.</span></span> |

> [!NOTE]
> <span data-ttu-id="da4e7-511">Libovolný počet atributů poznámky (vlastní atributy XML) lze na **hlavní** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-511">Any number of annotation attributes (custom XML attributes) may be applied to the **Principal** element.</span></span> <span data-ttu-id="da4e7-512">Uživatelských atributů, které však nemusí patřit do libovolný obor názvů XML, který je vyhrazen pro CSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-512">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="da4e7-513">Plně kvalifikovaných názvů pro všemi dvě vlastními atributy nemůže být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-513">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-514">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-514">Example</span></span>

<span data-ttu-id="da4e7-515">Následující příklad ukazuje element přidružení, který se používá **elementu ReferentialConstraint** elementu k určení sloupců, které jsou součástí **FK\_CustomerOrders** cizí klíč omezení.</span><span class="sxs-lookup"><span data-stu-id="da4e7-515">The following example shows an Association element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint.</span></span> <span data-ttu-id="da4e7-516">**Hlavní** určuje element **CustomerId** sloupec **zákazníka** tabulku jako hlavní konec omezení.</span><span class="sxs-lookup"><span data-stu-id="da4e7-516">The **Principal** element specifies the **CustomerId** column of the **Customer** table as the principal end of the constraint.</span></span>
...
## <a name="property-element-ssdl"></a><span data-ttu-id="da4e7-517">Property – Element (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-517">Property Element (SSDL)</span></span>

<span data-ttu-id="da4e7-518">**Vlastnost** prvek v store schema definition language (SSDL) představuje sloupci v tabulce v podkladové databázi.</span><span class="sxs-lookup"><span data-stu-id="da4e7-518">The **Property** element in store schema definition language (SSDL) represents a column in a table in the underlying database.</span></span> <span data-ttu-id="da4e7-519">**Vlastnost** prvky jsou podřízených elementů EntityType, které představují řádky v tabulce.</span><span class="sxs-lookup"><span data-stu-id="da4e7-519">**Property** elements are children of EntityType elements, which represent rows in a table.</span></span> <span data-ttu-id="da4e7-520">Každý **vlastnost** element definovaný v **EntityType** element představuje sloupci.</span><span class="sxs-lookup"><span data-stu-id="da4e7-520">Each **Property** element defined on an **EntityType** element represents a column.</span></span>

<span data-ttu-id="da4e7-521">A **vlastnost** element nemůže mít žádné podřízené prvky.</span><span class="sxs-lookup"><span data-stu-id="da4e7-521">A **Property** element cannot have any child elements.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-522">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-522">Applicable Attributes</span></span>

<span data-ttu-id="da4e7-523">Následující tabulka popisuje atributy, které mohou být použity **vlastnost** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-523">The following table describes the attributes that can be applied to the **Property** element.</span></span>

| <span data-ttu-id="da4e7-524">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-524">Attribute Name</span></span>            | <span data-ttu-id="da4e7-525">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-525">Is Required</span></span> | <span data-ttu-id="da4e7-526">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-526">Value</span></span>                                                                                                                                                                                                                           |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="da4e7-527">**Jméno**</span><span class="sxs-lookup"><span data-stu-id="da4e7-527">**Name**</span></span>                  | <span data-ttu-id="da4e7-528">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-528">Yes</span></span>         | <span data-ttu-id="da4e7-529">Název odpovídající sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-529">The name of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="da4e7-530">**Typ**</span><span class="sxs-lookup"><span data-stu-id="da4e7-530">**Type**</span></span>                  | <span data-ttu-id="da4e7-531">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-531">Yes</span></span>         | <span data-ttu-id="da4e7-532">Typ odpovídající sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-532">The type of the corresponding column.</span></span>                                                                                                                                                                                           |
| <span data-ttu-id="da4e7-533">**S povolenou hodnotou Null**</span><span class="sxs-lookup"><span data-stu-id="da4e7-533">**Nullable**</span></span>              | <span data-ttu-id="da4e7-534">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-534">No</span></span>          | <span data-ttu-id="da4e7-535">**Hodnota TRUE** (výchozí hodnota) nebo **False** v závislosti na tom, zda odpovídající sloupec může mít hodnotu null.</span><span class="sxs-lookup"><span data-stu-id="da4e7-535">**True** (the default value) or **False** depending on whether the corresponding column can have a null value.</span></span>                                                                                                                  |
| <span data-ttu-id="da4e7-536">**Výchozí hodnota**</span><span class="sxs-lookup"><span data-stu-id="da4e7-536">**DefaultValue**</span></span>          | <span data-ttu-id="da4e7-537">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-537">No</span></span>          | <span data-ttu-id="da4e7-538">Výchozí hodnota odpovídající sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-538">The default value of the corresponding column.</span></span>                                                                                                                                                                                  |
| <span data-ttu-id="da4e7-539">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="da4e7-539">**MaxLength**</span></span>             | <span data-ttu-id="da4e7-540">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-540">No</span></span>          | <span data-ttu-id="da4e7-541">Maximální délka odpovídající sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-541">The maximum length of the corresponding column.</span></span>                                                                                                                                                                                 |
| <span data-ttu-id="da4e7-542">**Hodnoty**</span><span class="sxs-lookup"><span data-stu-id="da4e7-542">**FixedLength**</span></span>           | <span data-ttu-id="da4e7-543">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-543">No</span></span>          | <span data-ttu-id="da4e7-544">**Hodnota TRUE** nebo **False** v závislosti na tom, zda se uloží odpovídající hodnotu sloupce jako řetězce pevné délky.</span><span class="sxs-lookup"><span data-stu-id="da4e7-544">**True** or **False** depending on whether the corresponding column value will be stored as a fixed length string.</span></span>                                                                                                              |
| <span data-ttu-id="da4e7-545">**Přesnost**</span><span class="sxs-lookup"><span data-stu-id="da4e7-545">**Precision**</span></span>             | <span data-ttu-id="da4e7-546">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-546">No</span></span>          | <span data-ttu-id="da4e7-547">Přesnost odpovídající sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-547">The precision of the corresponding column.</span></span>                                                                                                                                                                                      |
| <span data-ttu-id="da4e7-548">**Škálování**</span><span class="sxs-lookup"><span data-stu-id="da4e7-548">**Scale**</span></span>                 | <span data-ttu-id="da4e7-549">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-549">No</span></span>          | <span data-ttu-id="da4e7-550">Škálování odpovídající sloupec.</span><span class="sxs-lookup"><span data-stu-id="da4e7-550">The scale of the corresponding column.</span></span>                                                                                                                                                                                          |
| <span data-ttu-id="da4e7-551">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="da4e7-551">**Unicode**</span></span>               | <span data-ttu-id="da4e7-552">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-552">No</span></span>          | <span data-ttu-id="da4e7-553">**Hodnota TRUE** nebo **False** v závislosti na tom, jestli se uloží odpovídající hodnotu sloupce jako řetězec s kódováním Unicode.</span><span class="sxs-lookup"><span data-stu-id="da4e7-553">**True** or **False** depending on whether the corresponding column value will be stored as a Unicode string.</span></span>                                                                                                                   |
| <span data-ttu-id="da4e7-554">**Kolace**</span><span class="sxs-lookup"><span data-stu-id="da4e7-554">**Collation**</span></span>             | <span data-ttu-id="da4e7-555">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-555">No</span></span>          | <span data-ttu-id="da4e7-556">Řetězec, který určuje pořadí řazení, který se má použít ve zdroji dat.</span><span class="sxs-lookup"><span data-stu-id="da4e7-556">A string that specifies the collating sequence to be used in the data source.</span></span>                                                                                                                                                   |
| <span data-ttu-id="da4e7-557">**SRID**</span><span class="sxs-lookup"><span data-stu-id="da4e7-557">**SRID**</span></span>                  | <span data-ttu-id="da4e7-558">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-558">No</span></span>          | <span data-ttu-id="da4e7-559">Odkaz na identifikátor spatial systému.</span><span class="sxs-lookup"><span data-stu-id="da4e7-559">Spatial System Reference Identifier.</span></span> <span data-ttu-id="da4e7-560">Platí pouze pro vlastnosti prostorových typů.</span><span class="sxs-lookup"><span data-stu-id="da4e7-560">Valid only for properties of spatial types.</span></span> <span data-ttu-id="da4e7-561">Další informace najdete v tématu [SRID](http://en.wikipedia.org/wiki/SRID) a [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span><span class="sxs-lookup"><span data-stu-id="da4e7-561">For more information, see [SRID](http://en.wikipedia.org/wiki/SRID) and [SRID (SQL Server)](https://msdn.microsoft.com/library/bb964707.aspx).</span></span> |
| <span data-ttu-id="da4e7-562">**Výčet StoreGeneratedPattern**</span><span class="sxs-lookup"><span data-stu-id="da4e7-562">**StoreGeneratedPattern**</span></span> | <span data-ttu-id="da4e7-563">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-563">No</span></span>          | <span data-ttu-id="da4e7-564">**Žádný**, **Identity** (Pokud je hodnota odpovídající sloupec identity, který je vygenerován v databázi), nebo **vypočítané** (Pokud odpovídající sloupec hodnota byla vypočítána v databázi).</span><span class="sxs-lookup"><span data-stu-id="da4e7-564">**None**, **Identity** (if the corresponding column value is an identity that is generated in the database), or **Computed** (if the corresponding column value is computed in the database).</span></span> <span data-ttu-id="da4e7-565">Není platné pro RowType vlastnosti.</span><span class="sxs-lookup"><span data-stu-id="da4e7-565">Not Valid for RowType properties.</span></span> |

> [!NOTE]
> <span data-ttu-id="da4e7-566">Libovolný počet atributů poznámky (vlastní atributy XML) lze na **vlastnost** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-566">Any number of annotation attributes (custom XML attributes) may be applied to the **Property** element.</span></span> <span data-ttu-id="da4e7-567">Uživatelských atributů, které však nemusí patřit do libovolný obor názvů XML, který je vyhrazen pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-567">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="da4e7-568">Plně kvalifikovaných názvů pro všemi dvě vlastními atributy nemůže být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-568">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-569">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-569">Example</span></span>

<span data-ttu-id="da4e7-570">Následující příklad ukazuje **EntityType** element s dva podřízené **vlastnost** prvky:</span><span class="sxs-lookup"><span data-stu-id="da4e7-570">The following example shows an **EntityType** element with two child **Property** elements:</span></span>
...
## <a name="propertyref-element-ssdl"></a><span data-ttu-id="da4e7-571">Element PropertyRef (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-571">PropertyRef Element (SSDL)</span></span>

<span data-ttu-id="da4e7-572">**PropertyRef** prvek store schema definition language (SSDL) odkazuje na vlastnost definovaný v elementu EntityType k označení, že vlastnost bude provádět jednu z následujících rolí:</span><span class="sxs-lookup"><span data-stu-id="da4e7-572">The **PropertyRef** element in store schema definition language (SSDL) references a property defined on an EntityType element to indicate that the property will perform one of the following roles:</span></span>

-   <span data-ttu-id="da4e7-573">Být součástí primárního klíče tabulky, který **EntityType** představuje.</span><span class="sxs-lookup"><span data-stu-id="da4e7-573">Be part of the primary key of the table that the **EntityType** represents.</span></span> <span data-ttu-id="da4e7-574">Jeden nebo více **PropertyRef** prvky můžete použít k definování primární klíč.</span><span class="sxs-lookup"><span data-stu-id="da4e7-574">One or more **PropertyRef** elements can be used to define a primary key.</span></span> <span data-ttu-id="da4e7-575">Další informace najdete v elementu Key.</span><span class="sxs-lookup"><span data-stu-id="da4e7-575">For more information, see Key element.</span></span>
-   <span data-ttu-id="da4e7-576">Být závislé nebo hlavní konec referenčního omezení.</span><span class="sxs-lookup"><span data-stu-id="da4e7-576">Be the dependent or principal end of a referential constraint.</span></span> <span data-ttu-id="da4e7-577">Další informace najdete v elementu ReferentialConstraint elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-577">For more information, see ReferentialConstraint element.</span></span>

<span data-ttu-id="da4e7-578">**PropertyRef** element může obsahovat pouze následujících podřízených elementů:</span><span class="sxs-lookup"><span data-stu-id="da4e7-578">The **PropertyRef** element can only have the following child elements:</span></span>

-   <span data-ttu-id="da4e7-579">Dokumentace ke službě (žádný nebo jeden)</span><span class="sxs-lookup"><span data-stu-id="da4e7-579">Documentation (zero or one)</span></span>
-   <span data-ttu-id="da4e7-580">Elementů poznámky</span><span class="sxs-lookup"><span data-stu-id="da4e7-580">Annotation elements</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-581">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-581">Applicable Attributes</span></span>

<span data-ttu-id="da4e7-582">Následující tabulka popisuje atributy, které mohou být použity **PropertyRef** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-582">The table below describes the attributes that can be applied to the **PropertyRef** element.</span></span>

| <span data-ttu-id="da4e7-583">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-583">Attribute Name</span></span> | <span data-ttu-id="da4e7-584">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-584">Is Required</span></span> | <span data-ttu-id="da4e7-585">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-585">Value</span></span>                                |
|:---------------|:------------|:-------------------------------------|
| <span data-ttu-id="da4e7-586">**Jméno**</span><span class="sxs-lookup"><span data-stu-id="da4e7-586">**Name**</span></span>       | <span data-ttu-id="da4e7-587">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-587">Yes</span></span>         | <span data-ttu-id="da4e7-588">Název odkazované vlastnosti.</span><span class="sxs-lookup"><span data-stu-id="da4e7-588">The name of the referenced property.</span></span> |

> [!NOTE]
> <span data-ttu-id="da4e7-589">Libovolný počet atributů poznámky (vlastní atributy XML) lze na **PropertyRef** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-589">Any number of annotation attributes (custom XML attributes) may be applied to the **PropertyRef** element.</span></span> <span data-ttu-id="da4e7-590">Uživatelských atributů, které však nemusí patřit do libovolný obor názvů XML, který je vyhrazen pro CSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-590">However, custom attributes may not belong to any XML namespace that is reserved for CSDL.</span></span> <span data-ttu-id="da4e7-591">Plně kvalifikovaných názvů pro všemi dvě vlastními atributy nemůže být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-591">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-592">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-592">Example</span></span>

<span data-ttu-id="da4e7-593">Následující příklad ukazuje **PropertyRef** element sloužící k odkazování na vlastnost, která je definována na definovat primární klíč **EntityType** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-593">The following example shows a **PropertyRef** element used to define a primary key by referencing a property that is defined on an **EntityType** element.</span></span>
...
## <a name="referentialconstraint-element-ssdl"></a><span data-ttu-id="da4e7-594">Element elementu ReferentialConstraint (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-594">ReferentialConstraint Element (SSDL)</span></span>

<span data-ttu-id="da4e7-595">**Elementu ReferentialConstraint** prvek v store schema definition language (SSDL) představuje omezení cizího klíče (také nazývané omezení referenční integrity) v podkladové databázi.</span><span class="sxs-lookup"><span data-stu-id="da4e7-595">The **ReferentialConstraint** element in store schema definition language (SSDL) represents a foreign key constraint (also called a referential integrity constraint) in the underlying database.</span></span> <span data-ttu-id="da4e7-596">Objektem zabezpečení a závislými konce omezení jsou určena pomocí podřízených prvků objektu zabezpečení a závislé.</span><span class="sxs-lookup"><span data-stu-id="da4e7-596">The principal and dependent ends of the constraint are specified by the Principal and Dependent child elements, respectively.</span></span> <span data-ttu-id="da4e7-597">Sloupce, které jsou součástí objektem zabezpečení a závislými elementy end jsou odkazovány pomocí PropertyRef elementy.</span><span class="sxs-lookup"><span data-stu-id="da4e7-597">Columns that participate in the principal and dependent ends are referenced with PropertyRef elements.</span></span>

<span data-ttu-id="da4e7-598">**Elementu ReferentialConstraint** element je volitelný podřízený prvek elementu Association.</span><span class="sxs-lookup"><span data-stu-id="da4e7-598">The **ReferentialConstraint** element is an optional child element of the Association element.</span></span> <span data-ttu-id="da4e7-599">Pokud **elementu ReferentialConstraint** element není slouží k omezení cizího klíče, který je zadán v mapování **přidružení** element, AssociationSetMapping element musí k tomu použít.</span><span class="sxs-lookup"><span data-stu-id="da4e7-599">If a **ReferentialConstraint** element is not used to map the foreign key constraint that is specified in the **Association** element, an AssociationSetMapping element must be used to do this.</span></span>

<span data-ttu-id="da4e7-600">**Elementu ReferentialConstraint** prvek může mít následujících podřízených elementů:</span><span class="sxs-lookup"><span data-stu-id="da4e7-600">The **ReferentialConstraint** element can have the following child elements:</span></span>

-   <span data-ttu-id="da4e7-601">Dokumentace ke službě (žádný nebo jeden)</span><span class="sxs-lookup"><span data-stu-id="da4e7-601">Documentation (zero or one)</span></span>
-   <span data-ttu-id="da4e7-602">Objekt zabezpečení (právě jeden)</span><span class="sxs-lookup"><span data-stu-id="da4e7-602">Principal (exactly one)</span></span>
-   <span data-ttu-id="da4e7-603">Závislé (právě jeden)</span><span class="sxs-lookup"><span data-stu-id="da4e7-603">Dependent (exactly one)</span></span>
-   <span data-ttu-id="da4e7-604">Elementů poznámky (nula nebo více)</span><span class="sxs-lookup"><span data-stu-id="da4e7-604">Annotation elements (zero or more)</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-605">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-605">Applicable Attributes</span></span>

<span data-ttu-id="da4e7-606">Libovolný počet atributů poznámky (vlastní atributy XML) lze na **elementu ReferentialConstraint** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-606">Any number of annotation attributes (custom XML attributes) may be applied to the **ReferentialConstraint** element.</span></span> <span data-ttu-id="da4e7-607">Uživatelských atributů, které však nemusí patřit do libovolný obor názvů XML, který je vyhrazen pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-607">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="da4e7-608">Plně kvalifikovaných názvů pro všemi dvě vlastními atributy nemůže být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-608">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-609">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-609">Example</span></span>

<span data-ttu-id="da4e7-610">Následující příklad ukazuje **přidružení** element, který se používá **elementu ReferentialConstraint** elementu k určení sloupců, které jsou součástí **FK\_CustomerOrders**  omezení cizího klíče:</span><span class="sxs-lookup"><span data-stu-id="da4e7-610">The following example shows an **Association** element that uses a **ReferentialConstraint** element to specify the columns that participate in the **FK\_CustomerOrders** foreign key constraint:</span></span>
...
## <a name="returntype-element-ssdl"></a><span data-ttu-id="da4e7-611">Element ReturnType (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-611">ReturnType Element (SSDL)</span></span>

<span data-ttu-id="da4e7-612">**ReturnType** element v store schema definition language (SSDL) určuje návratový typ pro funkci, která je definována v **funkce** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-612">The **ReturnType** element in store schema definition language (SSDL) specifies the return type for a function that is defined in a **Function** element.</span></span> <span data-ttu-id="da4e7-613">Funkce, návratový typ je také možné zadat při **ReturnType** atribut.</span><span class="sxs-lookup"><span data-stu-id="da4e7-613">A function return type can also be specified with a **ReturnType** attribute.</span></span>

<span data-ttu-id="da4e7-614">Návratový typ funkce se zadaným **typ** atribut nebo **ReturnType** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-614">The return type of a function is specified with the **Type** attribute or the **ReturnType** element.</span></span>

<span data-ttu-id="da4e7-615">**ReturnType** prvek může mít následujících podřízených elementů:</span><span class="sxs-lookup"><span data-stu-id="da4e7-615">The **ReturnType** element can have the following child elements:</span></span>

- <span data-ttu-id="da4e7-616">Objekt CollectionType (jeden)</span><span class="sxs-lookup"><span data-stu-id="da4e7-616">CollectionType (one)</span></span>  

> [!NOTE]
> <span data-ttu-id="da4e7-617">Libovolný počet atributů poznámky (vlastní atributy XML) lze na **ReturnType** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-617">Any number of annotation attributes (custom XML attributes) may be applied to the **ReturnType** element.</span></span> <span data-ttu-id="da4e7-618">Uživatelských atributů, které však nemusí patřit do libovolný obor názvů XML, který je vyhrazen pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-618">However, custom attributes may not belong to any XML namespace that is reserved for SSDL.</span></span> <span data-ttu-id="da4e7-619">Plně kvalifikovaných názvů pro všemi dvě vlastními atributy nemůže být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-619">The fully-qualified names for any two custom attributes cannot be the same.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-620">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-620">Example</span></span>

<span data-ttu-id="da4e7-621">Následující příklad používá **funkce** , který vrátí kolekce řádků.</span><span class="sxs-lookup"><span data-stu-id="da4e7-621">The following example uses a **Function** that returns a collection of rows.</span></span>
...
## <a name="rowtype-element-ssdl"></a><span data-ttu-id="da4e7-622">Element RowType (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-622">RowType Element (SSDL)</span></span>

<span data-ttu-id="da4e7-623">A **RowType** prvek v store schema definition language (SSDL) definuje nepojmenovanou strukturu jako návratový typ pro funkci definovanou v úložišti.</span><span class="sxs-lookup"><span data-stu-id="da4e7-623">A **RowType** element in store schema definition language (SSDL) defines an unnamed structure as a return type for a function defined in the store.</span></span>

<span data-ttu-id="da4e7-624">A **RowType** prvek je podřízený prvek **CollectionType** element:</span><span class="sxs-lookup"><span data-stu-id="da4e7-624">A **RowType** element is the child element of **CollectionType** element:</span></span>

<span data-ttu-id="da4e7-625">A **RowType** prvek může mít následujících podřízených elementů:</span><span class="sxs-lookup"><span data-stu-id="da4e7-625">A **RowType** element can have the following child elements:</span></span>

- <span data-ttu-id="da4e7-626">Vlastnosti (jeden nebo více)</span><span class="sxs-lookup"><span data-stu-id="da4e7-626">Property (one or more)</span></span>  

### <a name="example"></a><span data-ttu-id="da4e7-627">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-627">Example</span></span>

<span data-ttu-id="da4e7-628">Následující příklad ukazuje funkci úložiště, který používá **CollectionType** elementu k určení, že funkce vrátí kolekce řádků (jak je uvedeno v **RowType** element).</span><span class="sxs-lookup"><span data-stu-id="da4e7-628">The following example shows a store function that uses a **CollectionType** element to specify that the function returns a collection of rows (as specified in the **RowType** element).</span></span>
...
## <a name="schema-element-ssdl"></a><span data-ttu-id="da4e7-629">Element schématu (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-629">Schema Element (SSDL)</span></span>

<span data-ttu-id="da4e7-630">**Schématu** prvek store schema definition language (SSDL) je kořenovým elementem definice modelu úložiště.</span><span class="sxs-lookup"><span data-stu-id="da4e7-630">The **Schema** element in store schema definition language (SSDL) is the root element of a storage model definition.</span></span> <span data-ttu-id="da4e7-631">Obsahuje definice pro objekty, funkce a kontejnerů, které tvoří modelu úložiště.</span><span class="sxs-lookup"><span data-stu-id="da4e7-631">It contains definitions for the objects, functions, and containers that make up a storage model.</span></span>

<span data-ttu-id="da4e7-632">**Schématu** element může obsahovat nula nebo více z následujících podřízených elementů:</span><span class="sxs-lookup"><span data-stu-id="da4e7-632">The **Schema** element may contain zero or more of the following child elements:</span></span>

-   <span data-ttu-id="da4e7-633">Přidružení</span><span class="sxs-lookup"><span data-stu-id="da4e7-633">Association</span></span>
-   <span data-ttu-id="da4e7-634">Typ entity</span><span class="sxs-lookup"><span data-stu-id="da4e7-634">EntityType</span></span>
-   <span data-ttu-id="da4e7-635">EntityContainer</span><span class="sxs-lookup"><span data-stu-id="da4e7-635">EntityContainer</span></span>
-   <span data-ttu-id="da4e7-636">Funkce</span><span class="sxs-lookup"><span data-stu-id="da4e7-636">Function</span></span>

<span data-ttu-id="da4e7-637">**Schématu** prvek používá **Namespace** atribut pro definování oboru názvů pro objekty typu a přidružení entit v modelu úložiště.</span><span class="sxs-lookup"><span data-stu-id="da4e7-637">The **Schema** element uses the **Namespace** attribute to define the namespace for the entity type and association objects in a storage model.</span></span> <span data-ttu-id="da4e7-638">V rámci oboru názvů může mít žádné dva objekty se stejným názvem.</span><span class="sxs-lookup"><span data-stu-id="da4e7-638">Within a namespace, no two objects can have the same name.</span></span>

<span data-ttu-id="da4e7-639">Obor názvů modelu úložiště se liší od oboru názvů XML **schématu** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-639">A storage model namespace is different from the XML namespace of the **Schema** element.</span></span> <span data-ttu-id="da4e7-640">Obor názvů modelu úložiště (podle definice **Namespace** atribut) je logický kontejner pro typy entit a přidružení typů.</span><span class="sxs-lookup"><span data-stu-id="da4e7-640">A storage model namespace (as defined by the **Namespace** attribute) is a logical container for entity types and association types.</span></span> <span data-ttu-id="da4e7-641">Obor názvů XML (indikován **xmlns** atribut) z **schématu** element je výchozí obor názvů pro podřízené prvky a atributy **schématu** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-641">The XML namespace (indicated by the **xmlns** attribute) of a **Schema** element is the default namespace for child elements and attributes of the **Schema** element.</span></span> <span data-ttu-id="da4e7-642">Obory názvů XML formuláře http://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (kde RRRR a MM představují roku a měsíce v uvedeném pořadí) jsou vyhrazené pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-642">XML namespaces of the form http://schemas.microsoft.com/ado/YYYY/MM/edm/ssdl (where YYYY and MM represent a year and month respectively) are reserved for SSDL.</span></span> <span data-ttu-id="da4e7-643">Vlastní elementy a atributy nemohou být v oborech názvů, které mají tento formulář.</span><span class="sxs-lookup"><span data-stu-id="da4e7-643">Custom elements and attributes cannot be in namespaces that have this form.</span></span>

### <a name="applicable-attributes"></a><span data-ttu-id="da4e7-644">Příslušné atributy</span><span class="sxs-lookup"><span data-stu-id="da4e7-644">Applicable Attributes</span></span>

<span data-ttu-id="da4e7-645">Následující tabulka popisuje atributy lze použít **schématu** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-645">The table below describes the attributes can be applied to the **Schema** element.</span></span>

| <span data-ttu-id="da4e7-646">Název atributu</span><span class="sxs-lookup"><span data-stu-id="da4e7-646">Attribute Name</span></span>            | <span data-ttu-id="da4e7-647">Vyžaduje se</span><span class="sxs-lookup"><span data-stu-id="da4e7-647">Is Required</span></span> | <span data-ttu-id="da4e7-648">Hodnota</span><span class="sxs-lookup"><span data-stu-id="da4e7-648">Value</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:--------------------------|:------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="da4e7-649">**Namespace**</span><span class="sxs-lookup"><span data-stu-id="da4e7-649">**Namespace**</span></span>             | <span data-ttu-id="da4e7-650">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-650">Yes</span></span>         | <span data-ttu-id="da4e7-651">Obor názvů model úložiště.</span><span class="sxs-lookup"><span data-stu-id="da4e7-651">The namespace of the storage model.</span></span> <span data-ttu-id="da4e7-652">Hodnota **Namespace** atribut se používá k vytvoření plně kvalifikovaný název typu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-652">The value of the **Namespace** attribute is used to form the fully qualified name of a type.</span></span> <span data-ttu-id="da4e7-653">Například pokud **EntityType** s názvem *zákazníka* je v oboru názvů ExampleModel.Store pak plně kvalifikovaný název **EntityType** je ExampleModel.Store.Customer.</span><span class="sxs-lookup"><span data-stu-id="da4e7-653">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace, then the fully qualified name of the **EntityType** is ExampleModel.Store.Customer.</span></span> <br/> <span data-ttu-id="da4e7-654">Následující řetězce nelze použít jako hodnotu **Namespace** atribut: **systému**, **přechodné**, nebo **Edm**.</span><span class="sxs-lookup"><span data-stu-id="da4e7-654">The following strings cannot be used as the value for the **Namespace** attribute: **System**, **Transient**, or **Edm**.</span></span> <span data-ttu-id="da4e7-655">Hodnota **Namespace** atribut nemůže být stejná jako hodnota pro **Namespace** atribut v elementu CSDL Schema.</span><span class="sxs-lookup"><span data-stu-id="da4e7-655">The value for the **Namespace** attribute cannot be the same as the value for the **Namespace** attribute in the CSDL Schema element.</span></span> |
| <span data-ttu-id="da4e7-656">**Alias**</span><span class="sxs-lookup"><span data-stu-id="da4e7-656">**Alias**</span></span>                 | <span data-ttu-id="da4e7-657">Ne</span><span class="sxs-lookup"><span data-stu-id="da4e7-657">No</span></span>          | <span data-ttu-id="da4e7-658">Identifikátor, použijí se místo názvu oboru názvů.</span><span class="sxs-lookup"><span data-stu-id="da4e7-658">An identifier used in place of the namespace name.</span></span> <span data-ttu-id="da4e7-659">Například pokud **EntityType** s názvem *zákazníka* je v oboru názvů ExampleModel.Store a hodnoty **Alias** atribut je *StorageModel*, můžete použít StorageModel.Customer jako plně kvalifikovaný název **EntityType.**</span><span class="sxs-lookup"><span data-stu-id="da4e7-659">For example, if an **EntityType** named *Customer* is in the ExampleModel.Store namespace and the value of the **Alias** attribute is *StorageModel*, then you can use StorageModel.Customer as the fully qualified name of the **EntityType.**</span></span>                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="da4e7-660">**Zprostředkovatel**</span><span class="sxs-lookup"><span data-stu-id="da4e7-660">**Provider**</span></span>              | <span data-ttu-id="da4e7-661">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-661">Yes</span></span>         | <span data-ttu-id="da4e7-662">Zprostředkovatel dat.</span><span class="sxs-lookup"><span data-stu-id="da4e7-662">The data provider.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| <span data-ttu-id="da4e7-663">**ProviderManifestToken**</span><span class="sxs-lookup"><span data-stu-id="da4e7-663">**ProviderManifestToken**</span></span> | <span data-ttu-id="da4e7-664">Ano</span><span class="sxs-lookup"><span data-stu-id="da4e7-664">Yes</span></span>         | <span data-ttu-id="da4e7-665">Token, který označuje které manifest zprostředkovatele se vraťte k poskytovateli.</span><span class="sxs-lookup"><span data-stu-id="da4e7-665">A token that indicates to the provider which provider manifest to return.</span></span> <span data-ttu-id="da4e7-666">Je definován žádný formát pro daný token.</span><span class="sxs-lookup"><span data-stu-id="da4e7-666">No format for the token is defined.</span></span> <span data-ttu-id="da4e7-667">Hodnoty pro daný token je definována v poskytovateli.</span><span class="sxs-lookup"><span data-stu-id="da4e7-667">Values for the token are defined by the provider.</span></span> <span data-ttu-id="da4e7-668">Informace o manifestu tokeny zprostředkovatele SQL Server najdete v tématu SqlClient pro Entity Framework.</span><span class="sxs-lookup"><span data-stu-id="da4e7-668">For information about SQL Server provider manifest tokens, see SqlClient for Entity Framework.</span></span>                                                                                                                                                                                                                                                                                                                        |

### <a name="example"></a><span data-ttu-id="da4e7-669">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-669">Example</span></span>

<span data-ttu-id="da4e7-670">Následující příklad ukazuje **schématu** element, který obsahuje **EntityContainer** elementu, dvěma **EntityType** elementy a jeden **přidružení** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-670">The following example shows a **Schema** element that contains an **EntityContainer** element, two **EntityType** elements, and one **Association** element.</span></span>
...
## <a name="annotation-attributes"></a><span data-ttu-id="da4e7-671">Atributy poznámek</span><span class="sxs-lookup"><span data-stu-id="da4e7-671">Annotation Attributes</span></span>

<span data-ttu-id="da4e7-672">Atributy poznámek v store schema definition language (SSDL) jsou vlastní atributy XML v modelu úložiště, které poskytují další metadata o prvky v modelu úložiště.</span><span class="sxs-lookup"><span data-stu-id="da4e7-672">Annotation attributes in store schema definition language (SSDL) are custom XML attributes in the storage model that provide extra metadata about the elements in the storage model.</span></span> <span data-ttu-id="da4e7-673">Kromě s platnou strukturu XML, platí následující omezení atributů poznámky:</span><span class="sxs-lookup"><span data-stu-id="da4e7-673">In addition to having valid XML structure, the following constraints apply to annotation attributes:</span></span>

-   <span data-ttu-id="da4e7-674">Atributy poznámky nesmí být v libovolný obor názvů XML, který je vyhrazen pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-674">Annotation attributes must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="da4e7-675">Plně kvalifikovaných názvů atributů dvě poznámky nesmí být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-675">The fully-qualified names of any two annotation attributes must not be the same.</span></span>

<span data-ttu-id="da4e7-676">Více než jeden atribut poznámky se můžou vztahovat na daný prvek SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-676">More than one annotation attribute may be applied to a given SSDL element.</span></span> <span data-ttu-id="da4e7-677">Metadat obsažených v elementů poznámky je možný za běhu pomocí tříd v oboru názvů System.Data.Metadata.Edm.</span><span class="sxs-lookup"><span data-stu-id="da4e7-677">Metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-678">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-678">Example</span></span>

<span data-ttu-id="da4e7-679">Následující příklad ukazuje element EntityType, který má anotaci atributem použitým **OrderId** vlastnost.</span><span class="sxs-lookup"><span data-stu-id="da4e7-679">The following example shows an EntityType element that has an annotation attribute applied to the **OrderId** property.</span></span> <span data-ttu-id="da4e7-680">V příkladu také zobrazit poznámky prvek přidán do **EntityType** elementu.</span><span class="sxs-lookup"><span data-stu-id="da4e7-680">The example also show an annotation element added to the **EntityType** element.</span></span>
...
## <a name="annotation-elements-ssdl"></a><span data-ttu-id="da4e7-681">Elementů poznámky (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-681">Annotation Elements (SSDL)</span></span>

<span data-ttu-id="da4e7-682">Poznámka prvky store schema definition language (SSDL) jsou vlastní elementů XML v modelu úložiště, které poskytují další metadata týkající se modelu úložiště.</span><span class="sxs-lookup"><span data-stu-id="da4e7-682">Annotation elements in store schema definition language (SSDL) are custom XML elements in the storage model that provide extra metadata about the storage model.</span></span> <span data-ttu-id="da4e7-683">Kromě platný struktura XML elementů poznámky platí následující omezení:</span><span class="sxs-lookup"><span data-stu-id="da4e7-683">In addition to having valid XML structure, the following constraints apply to annotation elements:</span></span>

-   <span data-ttu-id="da4e7-684">Elementů poznámky nesmí být v libovolný obor názvů XML, který je vyhrazen pro SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-684">Annotation elements must not be in any XML namespace that is reserved for SSDL.</span></span>
-   <span data-ttu-id="da4e7-685">Plně kvalifikovaných názvů všech elementů dvě poznámky nesmí být stejné.</span><span class="sxs-lookup"><span data-stu-id="da4e7-685">The fully-qualified names of any two annotation elements must not be the same.</span></span>
-   <span data-ttu-id="da4e7-686">Elementů poznámky se musí vyskytovat za všechny ostatní podřízené prvky daného prvku SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-686">Annotation elements must appear after all other child elements of a given SSDL element.</span></span>

<span data-ttu-id="da4e7-687">Více než jeden element anotace může být podřízeným daného prvku SSDL.</span><span class="sxs-lookup"><span data-stu-id="da4e7-687">More than one annotation element may be a child of a given SSDL element.</span></span> <span data-ttu-id="da4e7-688">Od verze rozhraní .NET Framework verze 4, metadat obsažených v elementů poznámky je možný za běhu pomocí tříd v oboru názvů System.Data.Metadata.Edm.</span><span class="sxs-lookup"><span data-stu-id="da4e7-688">Starting with the .NET Framework version 4, metadata contained in annotation elements can be accessed at runtime by using classes in the System.Data.Metadata.Edm namespace.</span></span>

### <a name="example"></a><span data-ttu-id="da4e7-689">Příklad</span><span class="sxs-lookup"><span data-stu-id="da4e7-689">Example</span></span>

<span data-ttu-id="da4e7-690">Následující příklad ukazuje element EntityType, který má element anotace (**CustomElement**).</span><span class="sxs-lookup"><span data-stu-id="da4e7-690">The following example shows an EntityType element that has an annotation element (**CustomElement**).</span></span> <span data-ttu-id="da4e7-691">Tento příklad také ukazuje anotace atributem použitým **OrderId** vlastnost.</span><span class="sxs-lookup"><span data-stu-id="da4e7-691">The example also shows an annotation attribute applied to the **OrderId** property.</span></span>
...
## <a name="facets-ssdl"></a><span data-ttu-id="da4e7-692">Omezující vlastnosti (SSDL)</span><span class="sxs-lookup"><span data-stu-id="da4e7-692">Facets (SSDL)</span></span>

<span data-ttu-id="da4e7-693">Omezující vlastnosti v store schema definition language (SSDL) představují omezení na typy sloupců, které jsou uvedeny v prvcích vlastností.</span><span class="sxs-lookup"><span data-stu-id="da4e7-693">Facets in store schema definition language (SSDL) represent constraints on column types that are specified in Property elements.</span></span> <span data-ttu-id="da4e7-694">Omezující vlastnosti jsou implementovány jako atributy ve formátu XML na **vlastnost** elementy.</span><span class="sxs-lookup"><span data-stu-id="da4e7-694">Facets are implemented as XML attributes on **Property** elements.</span></span>

<span data-ttu-id="da4e7-695">Následující tabulka popisuje, které jsou podporovány v SSDL omezující vlastnosti:</span><span class="sxs-lookup"><span data-stu-id="da4e7-695">The following table describes the facets that are supported in SSDL:</span></span>

| <span data-ttu-id="da4e7-696">Omezující vlastnost</span><span class="sxs-lookup"><span data-stu-id="da4e7-696">Facet</span></span>           | <span data-ttu-id="da4e7-697">Popis</span><span class="sxs-lookup"><span data-stu-id="da4e7-697">Description</span></span>                                                                                                                                                                                                                                                 |
|:----------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="da4e7-698">**Kolace**</span><span class="sxs-lookup"><span data-stu-id="da4e7-698">**Collation**</span></span>   | <span data-ttu-id="da4e7-699">Určuje pořadí řazení (nebo pořadí řazení) pro použití při provádění porovnání a řazení operací na hodnotách vlastnosti.</span><span class="sxs-lookup"><span data-stu-id="da4e7-699">Specifies the collating sequence (or sorting sequence) to be used when performing comparison and ordering operations on values of the property.</span></span>                                                                                                             |
| <span data-ttu-id="da4e7-700">**Hodnoty**</span><span class="sxs-lookup"><span data-stu-id="da4e7-700">**FixedLength**</span></span> | <span data-ttu-id="da4e7-701">Určuje, zda se může lišit délka hodnoty sloupce.</span><span class="sxs-lookup"><span data-stu-id="da4e7-701">Specifies whether the length of the column value can vary.</span></span>                                                                                                                                                                                                  |
| <span data-ttu-id="da4e7-702">**MaxLength**</span><span class="sxs-lookup"><span data-stu-id="da4e7-702">**MaxLength**</span></span>   | <span data-ttu-id="da4e7-703">Určuje maximální délku hodnoty sloupce.</span><span class="sxs-lookup"><span data-stu-id="da4e7-703">Specifies the maximum length of the column value.</span></span>                                                                                                                                                                                                           |
| <span data-ttu-id="da4e7-704">**Přesnost**</span><span class="sxs-lookup"><span data-stu-id="da4e7-704">**Precision**</span></span>   | <span data-ttu-id="da4e7-705">Pro vlastnosti typu **desítkové**, určuje počet číslic, může mít hodnotu vlastnosti.</span><span class="sxs-lookup"><span data-stu-id="da4e7-705">For properties of type **Decimal**, specifies the number of digits a property value can have.</span></span> <span data-ttu-id="da4e7-706">Pro vlastnosti typu **čas**, **data a času**, a **DateTimeOffset**, určuje počet číslic za desetinnou čárkou sady sekund hodnotu ve sloupci.</span><span class="sxs-lookup"><span data-stu-id="da4e7-706">For properties of type **Time**, **DateTime**, and **DateTimeOffset**, specifies the number of digits for the fractional part of seconds of the column value.</span></span> |
| <span data-ttu-id="da4e7-707">**Škálování**</span><span class="sxs-lookup"><span data-stu-id="da4e7-707">**Scale**</span></span>       | <span data-ttu-id="da4e7-708">Určuje počet číslic vpravo od desetinné čárky pro hodnotu sloupce.</span><span class="sxs-lookup"><span data-stu-id="da4e7-708">Specifies the number of digits to the right of the decimal point for the column value.</span></span>                                                                                                                                                                      |
| <span data-ttu-id="da4e7-709">**Unicode**</span><span class="sxs-lookup"><span data-stu-id="da4e7-709">**Unicode**</span></span>     | <span data-ttu-id="da4e7-710">Určuje, zda hodnota sloupce ukládá jako kódování Unicode.</span><span class="sxs-lookup"><span data-stu-id="da4e7-710">Indicates whether the column value is stored as Unicode.</span></span>                                                                                                                                                                                                    |
