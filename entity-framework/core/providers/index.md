...
| [Pomelo.EntityFrameworkCore.MyCat](https://www.nuget.org/packages/Pomelo.EntityFrameworkCore.MyCat)                  | MyCAT serveru               | [Pomelo Foundation projektu](https://github.com/PomeloFoundation)              | Pouze předběžné verze      | [Soubor Readme](https://github.com/PomeloFoundation/Pomelo.EntityFrameworkCore.MyCat/blob/master/README.md)                                                                                               |
...
| [EntityFrameworkCore.Jet](https://www.nuget.org/packages/EntityFrameworkCore.Jet/)                                   | Soubory aplikace Microsoft Access     | [Bubi](https://github.com/bubibubi)                                           | .NET Framework       | [Soubor Readme](https://github.com/bubibubi/EntityFrameworkCore.Jet/blob/master/docs/README.md)                                                                                                           |
...
Mezitím vytvořil tým EF [EF Core zprostředkovateli ukázek pro databáze Oracle](https://github.com/aspnet/EntityFrameworkCore/tree/master/samples/OracleProvider).
Účelem projektu je nechcete vytvořit poskytovatele EF Core vlastněných společností Microsoft.
Začali jsme projekt tak, aby identifikovat mezery v EF Core relační a základní funkce, které jsme potřebovali adresu k zajištění lepší podpory pro Oracle.
By mělo také pomoci společnosti Oracle nebo třetími stranami úvodního kurzu JumpStart týkajícího vývoj poskytovatelé Oracle pro jádro EF Core.

Posoudíme příspěvky, které zlepšují ukázková implementace.
Také by Vítáme a podporu komunity snahy o vytvoření poskytovatele open-source systému Oracle pro jádro EF Core pomocí ukázky jako výchozí bod.
